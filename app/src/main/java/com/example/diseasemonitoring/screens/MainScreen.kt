...
import com.example.diseasemonitoring.screens.views.AddAppointmentDialog
...
fun DiseaseScreen(viewModel: DiseaseViewModels = viewModel()) {
    ...
    val appointmentList by viewModel.appointmentList.observeAsState(listOf())
    var showAddDiseaseDialog by remember { mutableStateOf(false) }
    var showAddAppointmentDialog by remember { mutableStateOf(false) }
    var showActionDiseaseButton by remember { mutableStateOf("") }
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            floatingActionButton = {
                if (showActionDiseaseButton == "home"){
                ...
                }else if(showActionDiseaseButton == "doctor_appointments"){
                    ExtendedFloatingActionButton(
            ...
            NavHost(
                ...
                composable("home") {
                    showActionDiseaseButton = "home"
                    HomeScreen(diseaseList, viewModel, showAddDiseaseDialog) { showAddDiseaseDialog = it }

                }
                composable("profile") {
                    showActionDiseaseButton = "profile"
                    ProfileScreen()

                }
                composable("doctor_appointments") {
                    showActionDiseaseButton = "doctor_appointments"
                    DoctorAppointmentsScreen(appointmentList, viewModel, showAddAppointmentDialog){ showAddAppointmentDialog = it }
                }
            }
